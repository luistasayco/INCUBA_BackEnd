...
namespace Net.Data
{
    public class EmailSenderRepository : RepositoryBase<BE_EmailSenderOptions>, IEmailSenderRepository
    {
        ...
        public Task SendEmailAsync(string email, string subject, string message, BE_MemoryStream archivo)
        {
            ...
            correo.Attachments.Add(new Attachment(archivo.FileMemoryStream, "Pruebas.pdf", "application/pdf"));
            return Cliente.SendMailAsync(correo);
        }

        public Task SendEmailAsync(string email, string subject, string message, BE_MemoryStream archivo, string nameFile)
        {
